            ...
            <div class="col-md-9">
                <form class="needs-validation" id="formulario" data-evento_id="<?= (isset($evento->nome)) ? $evento->evento_id : "" ?>">
                    ...
                    <div class="form-row">
                        ...
                        <?= (isset($evento->evento_id)) ? '<a href="./cadastro_atividade?evento_id='. $evento->evento_id .'"" class="btn btn-block btn-outline-dark" title="Adicionar Atividades"><i class="fas fa-plus"></i></a>': "" ?>
                        </div>
                        <div class="col-md-2">
